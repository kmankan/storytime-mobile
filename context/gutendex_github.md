...
gives every book with a MIME type _starting with_ the value. For example,
...
[`/books?search=dickens%20great`](http://gutendex.com/books?search=dickens%20great) includes _Great
Expectations_ by Charles Dickens.
